...
export const metadata: Metadata = {
  ...
  authors: [
    ...
    { name: "Community Scripts", url: "https://github.com/Dbz9" },
  ],
  creator: "Bram Suurd",
  publisher: "Community Scripts",
  metadataBase: new URL(`https://Dbz9.github.io/${basePath}/`),
  alternates: {
    canonical: `https://Dbz9.github.io/${basePath}/`,
  },
  viewport: {
    width: "device-width",
    initialScale: 1,
  ...
  openGraph: {
    ...
    description:
      "The official website for the Proxmox VE Helper-Scripts (Community) repository. Featuring over 300+ scripts to help you manage your Proxmox Virtual Environment.",
    url: `https://Dbz9.github.io/${basePath}/`,
    siteName: "Proxmox VE Helper-Scripts",
    images: [
      {
        url: `https://Dbz9.github.io/${basePath}/defaultimg.png`,
        width: 1200,
        height: 630,
  ...
  twitter: {
    ...
    description:
      "The official website for the Proxmox VE Helper-Scripts (Community) repository. Featuring over 300+ scripts to help you manage your Proxmox Virtual Environment.",
    images: [`https://Dbz9.github.io/${basePath}/defaultimg.png`],
  },
